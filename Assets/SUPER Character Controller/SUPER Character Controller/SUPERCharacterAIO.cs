...
public class SUPERCharacterAIO : MonoBehaviour{
    ...
    void Update(){
        ...
        #region Input
            ...
            MouseXY.x = Input.GetAxis("JoystickMouse Y");
            MouseXY.y = Input.GetAxis("JoystickMouse X");
            ...
            jumpInput_Momentary = Input.GetKey("joystick button 0");
            jumpInput_FrameOf = Input.GetKeyDown("joystick button 0");
            ...
            //                 // sprintInput_Momentary = Input.GetAxisRaw("Sprint") > 0;
            //                 // sprintInput_FrameOf = Input.GetAxisRaw("Sprint") > 0;
            //  }
            
            sprintInput_Momentary = Input.GetKey("joystick button 2");
            sprintInput_FrameOf = Input.GetKeyDown("joystick button 2");
            ...
            jumpInput_Momentary = Input.GetKey("Jump");
            ...
            sprintInput_FrameOf = Input.GetKeyDown(Fire3);
    ...
    public override void OnInspectorGUI(){
        ...
        if(cameraSettingsFoldout){
            ...
            if(t.cameraPerspective == PerspectiveModes._1stPerson){
                ...
                t.standingEyeHeight = EditorGUILayout.Slider(new GUIContent("Standing Eye Height", "The Eye height of the player measured from the center of the character's capsule and upwards."),t.standingEyeHeight,0,5);
